...
def success():  
    if request.method == 'POST':  
        ...
        # print(filename)
        print(category_val)
        return render_template("result2.html", name = f.filename, link=f.filename, disease=disease, severity=severity, severity_val=category_val, model=model_choose, severite_score=category_score)  
